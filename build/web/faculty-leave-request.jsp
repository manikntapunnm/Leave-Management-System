<%-- 
    Document   : faculty-leave-request
    Created on : 22-Jun-2023, 2:23:35 pm
    Author     : manikanta
--%>
...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item active"><a href="faculty-leave-request.jsp" class="nav-link">Request Leave</a></li>
	        	<li class="nav-item"><a href="faculty-status.jsp" class="nav-link">Status</a></li>
    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" data-stellar-background-ratio="0.5" style="background-image: url(images/bg_2.jpg);" >
    	...
    	<div class="container">
           ...
           <h3 class="mb-2 bread"></h3>
		          </div>
		 <form action="faculty-leave-request-action.jsp" class="appointment-form ftco-animate" method="POST" >
    <div class="d-md-flex">
    ...
    <div class="d-md-flex">
        <div class="form-group">
            <label for="end" style="color: white;">End Date</label><br>
            <input type="date" class="form-control pr-5" placeholder="End Date" name="end">
        </div>
    </div>
    <div class="d-md-flex">
        <div class="form-group">
            <textarea name="reason" id="" cols="30" rows="2" class="form-control" placeholder="Reason for leave"></textarea>
        </div>
    </div>
      <!--div class="d-md-flex">
        <div class="form-group">
            <label for="proof" style="color: white;">Proof (only images)</label><br>
            <input  class="form-control pr-5"  type="file" onchage="readURL(this)" accept="image/*" name="image">
        </div>
    </div-->
