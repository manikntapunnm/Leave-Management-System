...
<%-- 
    Document   : admin-employee-list
    Created on : 22-Jun-2023, 1:10:09 pm
    Author     : manikanta
--%>
...
<body>
  ...
  <%
    ...
    try {
      ...
      String countQuery = "SELECT COUNT(*) AS total FROM facultyd";
     ...
     String query = "SELECT * FROM facultyd LIMIT ?, ?";
  ...
  %>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="py-1">
                        <%--<img src="images/faces/face<%= rs.getRow() %>.jpg" alt="image" />--%>
    ...
    <%--= rs.getString(17) --%>
                    ...
                    <td ><%= rs.getString(2) %></td><!--userid-->
                    <td ><%= rs.getString(4) %></td><!--firstname-->
                    <td ><%= rs.getString(8) %></td><!--category-->
                    <td ><%= rs.getString(12) %></td><!--email-->
                    <td ><%= rs.getString(13) %></td><!--phone-->
                    <td ><%= rs.getString(15) %></td><!--city-->

                   
                    <td>
                   <a href="admin-manage-employee.jsp?id=<%=rs.getString(1)%>"><button class="btn btn-sm btn-primary">Update</button></a>
                      <a href="remove-employee.jsp?id=<%=rs.getString(1)%>"><button class="btn btn-sm btn-danger">Remove</button></a>
                    </td>
