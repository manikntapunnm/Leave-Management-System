<%-- 
    ...
    Created on : 22-Jun-2023, 2:44:03 pm
    Author     : manikanta
--%>
    ...
    <div class="container d-flex align-items-center px-4">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active"><a href="student-status.jsp" class="nav-link ">Status</a></li>
  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        ...
        <p class="breadcrumbs">
          <span class="mr-2">
            <a href="student-dashboard.jsp">Student <i class="ion-ios-arrow-forward"></i></a>
          </span>
          <span>Status<i class="ion-ios-arrow-forward"></i></span>
        </p>
      </div>
    </div>
  </div>
...
<%
   ...
   try {
      ...
      String query = "SELECT * FROM leaves WHERE userid = '" + userid + "' ORDER BY id DESC";
