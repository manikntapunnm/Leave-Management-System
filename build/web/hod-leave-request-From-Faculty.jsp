<%-- 
    Document   : hod-leave-request-From-Faculty
    Created on : 22-Jun-2023, 2:31:31 pm
    Author     : manikanta
--%>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="hod-leave-request-From-Faculty.jsp">From
                    Faculty</a></li>
              </ul>
            </div>
          </li>
...
<%
   ...
   try {
     ...
     // rs = st.executeQuery("SELECT * FROM leaves");
        ...
        <table class="table table-striped project-orders-table">
          ...
          <tbody>
            ...
            <% while (rs.next()) { 
                ...
                if (category.equalsIgnoreCase("Faculty") || category.equalsIgnoreCase("Trainers")) { 
            %>
            <tr>
              <td><%= rs.getInt(1) %></td>
...
try {
   ...
   //String query = "SELECT * FROM leaves WHERE category='Faculty' ORDER BY id DESC LIMIT " + start + ", " + recordsPerPage;
//   String query = "SELECT * FROM leaves WHERE category IN ('Faculty', 'Trainers') ORDER BY id DESC LIMIT " + start + ", " + recordsPerPage;
   String query = "SELECT * FROM leaves WHERE category IN ('Faculty', 'Trainers') ORDER BY action='pending' DESC LIMIT " + start + ", " + recordsPerPage;
...
//String countQuery = "SELECT COUNT(*) FROM leaves WHERE category='Faculty'";
String countQuery = "SELECT COUNT(*) FROM leaves WHERE category IN ('Faculty', 'Trainers')";
