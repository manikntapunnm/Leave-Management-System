<%-- 
    Document   : hod-my-profile-image-action
    Created on : 26-Jul-2023, 1:02:36 am
    Author     : manikanta
--%>
<%-- 
...
<%
   ...
   String userid = (String) session.getAttribute("userid");
    ...
    try {
        ...
        ps =conn.prepareStatement("UPDATE facultyd SET image = ?,imagename = ? WHERE userid = ?");
   ...
   int n = ps.executeUpdate();
        if (n > 0) {
            ...
            response.sendRedirect("hod-my-profile.jsp");
        } else {
