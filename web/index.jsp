<%-- 
    Document   : index
    Created on : 22-Jun-2023, 3:27:02 pm
    Author     : manikanta
--%>
		...
		<div class="container d-flex align-items-center px-4">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a href="faculty-login.jsp" class="nav-link">Faculty</a></li>
				...
				<div class="col-md-6 col-lg-3">
					<div class="ftco-footer-widget mb-5">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">2nd Floor metro piller
										No-A1662, Sirish road snehapur colony, LB nagar, Telangana</span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span class="text">+91
											8555887986</span></a></li>
								<li><a href="#"><span class="icon icon-envelope"></span><span
											class="text">info@codebook.in</span></a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="ftco-footer-widget mb-5 ml-md-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="admin-login.jsp"><span
										class="ion-ios-arrow-round-forward mr-2"></span>Principle</a></li>
							<li><a href="hod-login.jsp"><span class="ion-ios-arrow-round-forward mr-2"></span>HOD</a>
							</li>
							<li><a href="faculty-login.jsp"><span
										class="ion-ios-arrow-round-forward mr-2"></span>Faculty</a></li>
							<li><a href="student-login.jsp"><span
										class="ion-ios-arrow-round-forward mr-2"></span>Student</a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-6 col-lg-3">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						Copyright &copy;
						<script>document.write(new Date().getFullYear());</script> All rights reserved | &copy; 2022
						Designed and developed by <i class="icon-heart" aria-hidden="true"></i> by <a
							href="https://colorlib.com"  >FZ INFOTECH</a>
