<%-- 
    Document   : admin-manage-employee
    Created on : 22-Jun-2023, 2:16:36 pm
    Author     : manikanta
--%>
...
<body>
  ...
  <div class="container-scroller">
    ...
    try {
        ...
        rs = st.executeQuery("SELECT * FROM facultyd where id='" + id + "'");
        while (rs.next()) {
    %>
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Manage Employee</h4>
              <form class="forms-sample" action="admin-manage-employee-action.jsp?id=<%= rs.getString(1) %>" method="post">
              ...
              <div class="form-group row">
                ...
                <label for="branch" class="col-sm-3 col-form-label">Category</label>
                <div class="col-sm-9">
                   <input type="text" class="form-control" id="category" name="category" value="<%= rs.getString(8) %>">
                </div>
              </div>
              <div class="form-group row">
                <label for="phone" class="col-sm-3 col-form-label">Mobile</label>
                <div class="col-sm-9">
                   <input type="text" class="form-control" id="phone" name="phone" value="<%= rs.getString(13) %>">
                </div>
              </div>
              <div class="form-group row">
                <label for="email" class="col-sm-3 col-form-label">Email ID</label>
                <div class="col-sm-9">
                   <input type="email" class="form-control" id="email" name="email" value="<%= rs.getString(12) %>">
                </div>
              </div>
              <div class="form-group row">
              <label for="address2" class="col-sm-3 col-form-label">Address</label> 
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="city" name="city" value="<%= rs.getString(15) %>">
                </div>
              </div>
