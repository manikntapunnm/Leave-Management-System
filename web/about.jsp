<%-- 
    Document   : about
    Created on : 22-Jun-2023, 1:01:26 pm
    Author     : manikanta
--%>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_1.jpg');">
      ...
      <div class="container">
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
            ...
            <div class="img" style="background-image: url(images/about.jpg); border: 1px solid black;"></div>

					</div>
					<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
          	<h2 class="mb-4">Codebook.in Stablished Since 1960</h2>
