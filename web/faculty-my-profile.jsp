<%-- 
    Document   : faculty-my-profile
    Created on : 22-Jun-2023, 2:25:45 pm
    Author     : manikanta
--%>
    ...
    <div class="container d-flex align-items-center px-4">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active"><a href="faculty-my-profile.jsp" class="nav-link">My Profile</a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <p class="breadcrumbs">
                    <span class="mr-2">
                        <a href="faculty-dashboard.jsp">Faculty <i class="ion-ios-arrow-forward"></i></a>
                    </span>
                    <span>My Profile<i class="ion-ios-arrow-forward"></i></span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4 mb-xl-0">
        ...
        <div class="card-body text-center">
            <img style="width:100px; height:100px;" class="img-account-profile rounded-circle mb-2"
                src="getImage.jsp" alt="Faculty Image">
            <h5 class="mb-2 bread"><%= session.getAttribute("userid") %></h5>
            ...
            <!--form action="" method="post" enctype="multipart/form-data">
               ...
               <form action="faculty-my-profile-image-action.jsp" name="maniform" method="post"  >
            <table align="center" >
                <tr><td>
 ...
 <!-- Account Details Card -->
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="faculty-my-profile-action.jsp" method="post">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">UserId (Default)</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" value="<%= rs.getString("userid") %>"  name="userid" readonly>
                                        </div>
                                    </div>
...
%>
  ...
  <!--<%-- <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                           ...
                           button class="btn btn-primary" type="button">Upload new image</button
                            <form action="faculty-my-profile-action.jsp" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body text-center">
            ...
            <button class="btn btn-primary" type="button">Upload new image</button>
            <form action=" faculty-my-profile-image-action.jsp" method="post" enctype="multipart/form-data">
