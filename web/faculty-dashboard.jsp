<%-- 
    Document   : faculty-dashboard
    Created on : 22-Jun-2023, 2:22:40 pm
    Author     : manikanta
--%>
    ...
    <div class="container d-flex align-items-center px-4">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active"><a href="faculty-dashboard.jsp" class="nav-link pl-0">Dashboard</a></li>
      ...
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <h1 class="mb-2 bread"><%= session.getAttribute("firstname") %>'s Dashboard</h1>
           <h3 class="mb-2 bread"><%= session.getAttribute("category") %></h3>
          ...
          <!-- <h3 class="mb-2 bread"><%--<%= session.getAttribute("phone") %>--%></h3>-->
          <p class="breadcrumbs"><span class="mr-2">Faculty <i class="ion-ios-arrow-forward"></i></span>
