<%-- 
    Document   : hod-status
    Created on : 22-Jun-2023, 2:36:09 pm
    Author     : manikanta
--%>
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas mr-5" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
...
try {
    ...
    int start2 = (currentPage - 1) * recordsPerPage;

    // Prepare the SQL query with a WHERE condition to filter by the user ID and order by action
    String query = "SELECT * FROM leaves WHERE userid = ? ORDER BY CASE WHEN action = 'Pending' THEN 0 ELSE 1 END, action LIMIT ?, ?";
...
String countQuery = "SELECT COUNT(*) FROM leaves WHERE userid = ?";
          ...
          <div class="card-body">
            ...
            <div class="">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 <a
                  href="https://www.bootstrapdash.com/" class="text-muted"  >Codebook.in</a>. All rights
                reserved.</span>
            </div>
