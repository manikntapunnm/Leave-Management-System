<%-- 
    ...
    Created on : 22-Jun-2023, 1:09:19 pm
    Author     : manikanta
--%>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="admin-dashboard.jsp"><h5 style='color:white;'>Admin Dashboard</h5></a>
          <a class="navbar-brand brand-logo-mini" href="index.jsp"><h6 style="color:white; font-size: 15px;">Admin</h6><!--  <h6 style='color:white; font-size:"15px"'>Admin</h6>--></a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="admin-employee-list.jsp">Manage Employee</a>
                </li>
              </ul>
            </div>
          </li>
