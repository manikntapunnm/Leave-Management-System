<%-- 
    Document   : hod-request-leave
    Created on : 22-Jun-2023, 2:34:57 pm
    Author     : manikanta
--%>
...
<body>
  ...
  <div class="card">
    <div class="card-body" style="background-color:#ffe6ff;">
      ...
      <form action="hod-request-leave-action.jsp" method="post">
        <div class="form-group">
          <label for="start">From</label>
          <input type="date" class="form-control form-control-sm" id="start" name="start" aria-label="From" required>
        </div>
        <div class="form-group">
          <label for="end">To</label>
          <input type="date" class="form-control form-control-sm" id="end" name="end" aria-label="To" required>
        </div>
        <div class="form-group">
          <label for="reason">Reason</label>
          <input type="text" class="form-control form-control-sm" id="reason" name="reason" placeholder="Reason" aria-label="Reason" required>
        </div>
      ...
      <!-- Define the JavaScript function to show the SweetAlert notification 
<script>
  function showLeaveSubmittedAlert() {
    swal("Leave submitted successfully!", "", "success");
  }
  
  // Check if leaveSuccessMessage exists in the session and display SweetAlert notification
  var leaveSuccessMessage = '<%--= request.getSession().getAttribute("leaveSuccessMessage") --%>';
  if (leaveSuccessMessage && leaveSuccessMessage.trim() !== '') {
    swal("Success", leaveSuccessMessage, "success");
  }
</script>-->
