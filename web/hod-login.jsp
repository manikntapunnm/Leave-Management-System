<%-- 
    Document   : hod-login
    Created on : 22-Jun-2023, 2:33:37 pm
    Author     : manikanta
--%>
    ...
    <div class="container d-flex align-items-center px-4">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active"><a href="hod-login.jsp" class="nav-link">HOD</a></li>
        ...
        <div class="col-md-6 py-5 px-md-5">
          <div class="py-md-5">
            <div class="heading-section heading-section-white ftco-animate mb-5">
              <h2 class="mb-4">HOD Login</h2>

            </div>
            <form action="hod-login-action.jsp" class="appointment-form ftco-animate">
              <div class="d-md-flex">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="ftco-footer-widget mb-5 ml-md-4">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="faculty-login.jsp"><span class="ion-ios-arrow-round-forward mr-2"></span>Faculty</a>
              </li>
              <li><a href="student-login.jsp"><span class="ion-ios-arrow-round-forward mr-2"></span>Student</a>
              </li>
            </ul>
          </div>
        </div>
