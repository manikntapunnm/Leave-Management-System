<%-- 
    Document   : admin-add-employee
    Created on : 22-Jun-2023, 1:02:48 pm
    Author     : manikanta
--%>
            ...
            <ul class="nav">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="admin-add-employee.jsp">Add Employee</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="admin-employee-list.jsp">Manage Employee</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="form-elements">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="admin-add-student.jsp">Add Student</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="admin-student-list.jsp">Manage Student</a>
                    </li>
                ...
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body" style="background-color: #b3d9ff;">
                      ...
                      <form class="form-sample" action="add-employee-action.jsp" method="POST"  >
    ...
    <div class="col-md-6">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            <input class="file-upload-input" type="file" onchage="readURL(this)" accept="image/*" name="image" id="image"  required />
        </div>
      </div>
        ...
        <div class="col-sm-9">
          ...
          <div class="d-md-flex">
            <div class="form-group ml-md-4" style="margin-top:10px;">
              <button type="submit" class="btn btn-primary py-3 px-4"> Add Employee</button>
            </div>
          </div>
        </div>
      </div>
